    ...
    <div>
        ...
        <div class="flex min-h-screen bg-background relative w-full max-w-full overflow-x-hidden">
            ...
            >
                ...
                >
                    ...
                    >
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4" />
                ...
                <SidebarLink
                    v-if="canAny('manage settings', 'view settings')"
                ...
                >
                    <template #icon>
                        <svg class="w-5 h-5 text-golden-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <template #label>{{ t.sidebar?.site_settings || 'Site Settings' }}</template>
                </SidebarLink>
