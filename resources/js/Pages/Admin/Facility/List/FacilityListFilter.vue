          ...
          <div class="w-full lg:flex-1 lg:max-w-md xl:max-w-lg space-y-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                id="search"
                :placeholder="t.facility?.search_placeholder || 'Search facilities by name, phone...'"
              />
            </div>
          </div>
        </div>
...
const getInitialFilters = () => {
  if (props.initialFilters && (props.initialFilters.search || props.initialFilters.facility_type_id || props.initialFilters.governorate_id)) {
    return {
...
const applyFilters = (filterValues = null) => {
  ...
  if (currentFilters.facility_type_id) params.facility_type_id = currentFilters.facility_type_id;
  if (currentFilters.governorate_id) params.governorate_id = currentFilters.governorate_id;
