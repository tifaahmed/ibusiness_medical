...
export const facilityTypeUpdateSchema = z.object({
    name: translatableNameSchema,
});

export const validateFacilityTypeForm = (facilityTypeData, isUpdate = false) => {
    try {
        const schema = isUpdate ? facilityTypeUpdateSchema : facilityTypeSchema;
        
        // Ensure name is an object
        let nameValue = facilityTypeData.name || {};
