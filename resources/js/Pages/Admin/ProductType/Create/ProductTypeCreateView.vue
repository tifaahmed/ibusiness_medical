<template>
  <ProductTypeLayout>
    <div class="space-y-2 sm:space-y-3 md:space-y-4 p-2 sm:p-3 md:p-4 lg:p-6 w-full max-w-full">
      <Breadcrumb
        :title="t.product_type?.create || 'Create Product Type'"
        :breadcrumbs="[{ label: t.breadcrumbs?.product_types || 'Product Types', link: route('admin.product-type.list'), active: true }]"
      />
              ...
              <div class="flex gap-2 sm:gap-3 justify-end">
                ...
                <div class="relative inline-flex">
                  ...
                  >
                    ...
                    {{ t.product_type?.create || 'Create Product Type' }}
                  </button>
...
onMounted(() => {
  productTypeStore.initializeForm();
});

const handleSubmit = () => {
  productTypeStore.submitForm();
};
</script>
