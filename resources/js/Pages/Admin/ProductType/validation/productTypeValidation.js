...
export const validateProductTypeForm = (productTypeData, isUpdate = false) => {
    try {
        const schema = isUpdate ? productTypeUpdateSchema : productTypeSchema;

        // Ensure name is an object
        let nameValue = productTypeData.name || {};
