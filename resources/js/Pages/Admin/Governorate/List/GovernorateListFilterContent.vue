  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-end">
      <div class="w-full lg:flex-1 lg:max-w-md xl:max-w-lg space-y-2">
        <label data-slot="label" class="flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50 w-full ltr:justify-start rtl:justify-end ltr:text-left rtl:text-right" for="search">{{ t.common?.search || 'Search' }}</label>
        <div class="relative">
...
const applyFilters = (filterValues = null) => {
  ...
  router.get(route('admin.governorate.list'), params, {
    preserveState: true,
    preserveScroll: true,
    replace: true
  });
