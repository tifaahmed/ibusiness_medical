      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="relative">
          ...
          <input
            ...
            id="search"
            :placeholder="t.contract?.search_placeholder || 'Search by name...'"
          />
        </div>
      </div>
...
const hasActiveFilters = computed(() => {
  return !!(filters.value.search || filters.value.is_active !== '');
});
...
const applyFilters = (filterValues = null) => {
  ...
  router.get(route('admin.contract.list'), params, {
    preserveState: true,
    preserveScroll: true,
    replace: true
  });
