    ...
    <div class="container mx-auto px-4 py-6 md:px-6 lg:px-8 relative z-10">
      <div class="space-y-4">
        <form class="space-y-3" @submit.prevent="handleSubmit">
          <ServiceTypeForm :icon-options="iconOptions" :color-options="colorOptions" />
              ...
              <div class="flex gap-3 justify-end">
                ...
                <div class="relative inline-flex order-1 sm:order-2">
                  ...
                  >
                    ...
                    {{ t.serviceType?.create || 'Create Category' }}
                  </button>
...
onMounted(() => {
  serviceTypeStore.initializeForm();
});

const handleSubmit = () => {
  serviceTypeStore.submitForm();
};
</script>
