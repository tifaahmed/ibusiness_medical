      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="relative">
          ...
          <input
            ...
            id="search"
            :placeholder="t.partner_offer?.search_placeholder || 'Search by title...'"
          />
        </div>
      </div>
    </div>
...
const getInitialFilters = () => ({
  ...
  partner_id: props.initialFilters?.partner_id || '',
});
...
const handleReset = () => {
  filters.value = { search: '', partner_id: '' };
  applyFilters();
};
...
const applyFilters = (filterValues = null) => {
  ...
  router.get(route('admin.partner-offer.list'), params, {
    preserveState: true,
    preserveScroll: true,
    replace: true,
  });
