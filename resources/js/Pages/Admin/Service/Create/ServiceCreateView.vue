    ...
    <div class="container mx-auto px-4 py-6 md:px-6 lg:px-8 relative z-10">
      <div class="space-y-4">
        <form class="space-y-3" @submit.prevent="handleSubmit">
          <ServiceForm :service-types="serviceTypes" :governorates="governorates" :cities="cities" :tag-options="tagOptions" :tags="tags" />
              ...
              <div class="flex gap-3 justify-end">
                ...
                <div class="relative inline-flex order-1 sm:order-2">
                  ...
                  >
                    ...
                    {{ t.service?.create || 'Create Service' }}
                  </button>
                  <ErrorTrackButton :errors="serviceStore.validationErrors || {}" :debug-log="serviceStore.debugLog" />
                </div>
              </div>
            </div>
          </div>
...
onMounted(() => {
  serviceStore.initializeForm();
});

const handleSubmit = () => {
  serviceStore.submitForm();
};
</script>
