  ...
  <div class="w-full">
    ...
    >
      <div class="shrink-0 w-10 h-10 rounded-md bg-muted/40 flex items-center justify-center text-golden-yellow">
        <!-- PDF icon -->
        <svg v-if="previewKind === 'pdf'" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
