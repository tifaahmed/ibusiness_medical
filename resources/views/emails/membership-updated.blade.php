...
<head>
    ...
    <title>Membership Updated</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>Your Membership Has Been Updated</h1>
        </div>
        ...
        <div class="email-body">
            ...
            <div class="content">
                Your membership information has been successfully updated. Here are your current membership details:
            </div>
            ...
            <div class="membership-details">
                ...
                @if($membership->registration_date)
            ...
            <div class="content">
                If you have any questions about these changes or need assistance, please don't hesitate to contact us.
            </div>
