...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Dakahlia governorate
            $this->dakahlia = Governorate::where('slug', 'dakahlia')->first();
            
            if (!$this->dakahlia) {
                $this->command->error('Dakahlia governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Dakahlia...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->dakahlia->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/DakahliaData/dakahlia.json');
