# Damietta Data Seeders

This folder contains seeders for importing medical facilities data for Damietta governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Damietta governorate
...
- `DamiettaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `damietta.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\DamiettaData\\DamiettaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\DamiettaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\DamiettaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\DamiettaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\DamiettaData\\FacilityBranchSeeder
```
