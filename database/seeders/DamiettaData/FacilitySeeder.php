...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Damietta governorate
            $this->damietta = Governorate::where('slug', 'damietta')->first();
            
            if (!$this->damietta) {
                $this->command->error('Damietta governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Damietta...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->damietta->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/DamiettaData/damietta.json');
