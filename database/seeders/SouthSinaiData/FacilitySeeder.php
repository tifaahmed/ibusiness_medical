...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get South Sinai governorate
            $this->southSinai = Governorate::where('slug', 'south-sinai')->first();
            
            if (!$this->southSinai) {
                $this->command->error('South Sinai governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for South Sinai...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->southSinai->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/SouthSinaiData/south-sinai.json');
