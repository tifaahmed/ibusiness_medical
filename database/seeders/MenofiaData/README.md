# Menofia Data Seeders

This folder contains seeders for importing medical facilities data for Menofia governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Menofia governorate
...
- `MenofiaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `menofia.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\MenofiaData\\MenofiaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\MenofiaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\MenofiaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\MenofiaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\MenofiaData\\FacilityBranchSeeder
```
