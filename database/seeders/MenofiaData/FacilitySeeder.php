...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Menofia governorate
            $this->menofia = Governorate::where('slug', 'menofia')->first();
            
            if (!$this->menofia) {
                $this->command->error('Menofia governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Menofia...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->menofia->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/MenofiaData/menofia.json');
