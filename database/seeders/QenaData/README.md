...
This folder contains seeders for importing medical facilities data for Qena governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Qena governorate
...
- `QenaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `qena.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\QenaData\\QenaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\QenaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\QenaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\QenaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\QenaData\\FacilityBranchSeeder
```
