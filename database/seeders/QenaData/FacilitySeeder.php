...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Qena governorate
            $this->qena = Governorate::where('slug', 'qena')->first();
            
            if (!$this->qena) {
                $this->command->error('Qena governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Qena...");
    ...
    {
        $jsonFilePath = base_path('database/seeders/QenaData/qena.json');
