...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get New Valley governorate
            $this->newValley = Governorate::where('slug', 'new-valley')->first();
            
            if (!$this->newValley) {
                $this->command->error('New Valley governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for New Valley...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->newValley->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/NewValleyData/new-valley.json');
