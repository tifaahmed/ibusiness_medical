# New Valley Data Seeders

This folder contains seeders for importing medical facilities data for New Valley governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates New Valley governorate
...
- `NewValleyDataSeeder.php` - Main seeder that runs all seeders in correct order
- `new-valley.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\NewValleyData\\NewValleyDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\NewValleyData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\NewValleyData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\NewValleyData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\NewValleyData\\FacilityBranchSeeder
```
