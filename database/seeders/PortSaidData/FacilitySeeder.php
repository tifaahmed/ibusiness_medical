...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Port Said governorate
            $this->portSaid = Governorate::where('slug', 'port-said')->first();
            
            if (!$this->portSaid) {
                $this->command->error('Port Said governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Port Said...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->portSaid->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/PortSaidData/port-said.json');
