# Port Said Data Seeders

This folder contains seeders for importing medical facilities data for Port Said governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Port Said governorate
...
- `PortSaidDataSeeder.php` - Main seeder that runs all seeders in correct order
- `port-said.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\PortSaidData\\PortSaidDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\PortSaidData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\PortSaidData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\PortSaidData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\PortSaidData\\FacilityBranchSeeder
```
