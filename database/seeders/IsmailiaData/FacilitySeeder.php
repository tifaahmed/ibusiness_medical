...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Ismailia governorate
            $this->ismailia = Governorate::where('slug', 'ismailia')->first();
            
            if (!$this->ismailia) {
                $this->command->error('Ismailia governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Ismailia...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->ismailia->id,
                        ]
                    );
