...
class FacilityBranchSeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            $this->command->info("Starting branch import for Aswan...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    if (!empty($branches) && is_array($branches)) {
                        foreach ($branches as $branchIndex => $branchData) {
                            ...
                            // Handle location - can be string or object with ar/en
                            $location = '';
                            $locationAr = '';
                            $locationEn = '';
                            ...
                            $branch = FacilityBranch::updateOrCreate(
                                ...
                                [
                                    ...
                                    'phone' => !empty($branchData['phone']) ? trim($branchData['phone']) : null,
                                ]
                            );
                            ...
                            if ($branch->wasRecentlyCreated) {
                                ...
                                if (!empty($branchData['phone'])) $branchInfo[] = "Phone: " . $branchData['phone'];
