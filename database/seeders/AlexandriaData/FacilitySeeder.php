...
class FacilitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            $this->alexandria = Governorate::where('slug', 'alexandria')->first();
            
            if (!$this->alexandria) {
                $this->command->error('Alexandria governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Alexandria...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->alexandria->id,
                        ]
                    );
                    ...
                    if (!$hasBranches) {
                        // Get address and phones from facility data for creating main branch
