...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Sohag governorate
            $this->sohag = Governorate::where('slug', 'sohag')->first();
            
            if (!$this->sohag) {
                $this->command->error('Sohag governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Sohag...");
    ...
    {
        $jsonFilePath = base_path('database/seeders/SohagData/sohag.json');
