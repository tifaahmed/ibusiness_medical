...
This folder contains seeders for importing medical facilities data for Sohag governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Sohag governorate
...
- `SohagDataSeeder.php` - Main seeder that runs all seeders in correct order
- `sohag.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\SohagData\\SohagDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\SohagData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\SohagData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\SohagData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\SohagData\\FacilityBranchSeeder
```
