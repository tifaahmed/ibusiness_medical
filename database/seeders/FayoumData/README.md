...
This folder contains seeders for importing medical facilities data for Fayoum governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Fayoum governorate
...
- `FayoumDataSeeder.php` - Main seeder that runs all seeders in correct order
- `fayoum.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\FayoumData\\FayoumDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\FayoumData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\FayoumData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\FayoumData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\FayoumData\\FacilityBranchSeeder
```
