...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Fayoum governorate
            $this->fayoum = Governorate::where('slug', 'fayoum')->first();
            
            if (!$this->fayoum) {
                $this->command->error('Fayoum governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Fayoum...");
