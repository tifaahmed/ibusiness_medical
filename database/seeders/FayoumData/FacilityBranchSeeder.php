...
class FacilityBranchSeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            $this->command->info("Starting branch import for Fayoum...");
                ...
                if (is_string($branchData)) {
                    ...
                    $branch = FacilityBranch::updateOrCreate(
                        ...
                        [
                            ...
                            'phone' => !empty($facilityData['hotline']) ? trim($facilityData['hotline']) : (!empty($facilityData['phones']) ? trim($facilityData['phones'][0]) : null),
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/FayoumData/fayoum.json');
