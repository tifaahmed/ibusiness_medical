...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Assiut governorate
            $this->assiut = Governorate::where('slug', 'assiut')->first();
            
            if (!$this->assiut) {
                $this->command->error('Assiut governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Assiut...");
