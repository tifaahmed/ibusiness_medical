...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get North Sinai governorate
            $this->northSinai = Governorate::where('slug', 'north-sinai')->first();
            
            if (!$this->northSinai) {
                $this->command->error('North Sinai governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for North Sinai...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->northSinai->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/NorthSinaiData/north-sinai.json');
