# North Sinai Data Seeders

This folder contains seeders for importing medical facilities data for North Sinai governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates North Sinai governorate
...
- `NorthSinaiDataSeeder.php` - Main seeder that runs all seeders in correct order
- `north-sinai.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\NorthSinaiData\\NorthSinaiDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\NorthSinaiData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\NorthSinaiData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\NorthSinaiData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\NorthSinaiData\\FacilityBranchSeeder
```
