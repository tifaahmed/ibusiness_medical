...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Marsa Matrouh governorate
            $this->marsaMatrouh = Governorate::where('slug', 'marsa-matrouh')->first();
            
            if (!$this->marsaMatrouh) {
                $this->command->error('Marsa Matrouh governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Marsa Matrouh...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->marsaMatrouh->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/MarsaMatrouhData/marsa-matrouh.json');
