...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Luxor governorate
            $this->luxor = Governorate::where('slug', 'luxor')->first();
            
            if (!$this->luxor) {
                $this->command->error('Luxor governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Luxor...");
