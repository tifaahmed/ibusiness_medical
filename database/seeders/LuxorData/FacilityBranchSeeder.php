...
class FacilityBranchSeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            $this->command->info("Starting branch import for Luxor...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    if (!empty($branches) && is_array($branches)) {
                        foreach ($branches as $branchIndex => $branchData) {
                            ...
                            // Check for 'location' field (Luxor format - can be object with ar/en)
    ...
    {
        $jsonFilePath = base_path('database/seeders/LuxorData/luxor.json');
