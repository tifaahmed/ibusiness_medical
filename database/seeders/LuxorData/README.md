...
This folder contains seeders for importing medical facilities data for Luxor governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Luxor governorate
...
- `LuxorDataSeeder.php` - Main seeder that runs all seeders in correct order
- `luxor.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\LuxorData\\LuxorDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\LuxorData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\LuxorData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\LuxorData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\LuxorData\\FacilityBranchSeeder
```
