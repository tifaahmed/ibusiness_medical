# Sharqia Data Seeders

This folder contains seeders for importing medical facilities data for Sharqia governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Sharqia governorate
...
- `SharqiaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `sharqia.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\SharqiaData\\SharqiaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\SharqiaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\SharqiaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\SharqiaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\SharqiaData\\FacilityBranchSeeder
```
...
- **Branches Array**: Supports both string arrays (like `["Zagazig", "Minya El Qamh"]`) and object arrays
