...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Sharqia governorate
            $this->sharqia = Governorate::where('slug', 'sharqia')->first();
            
            if (!$this->sharqia) {
                $this->command->error('Sharqia governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Sharqia...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->sharqia->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/SharqiaData/sharqia.json');
