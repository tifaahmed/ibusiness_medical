...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Suez/Gharbia governorate
            $this->suezGharbia = Governorate::where('slug', 'suez-gharbia')->first();
            
            if (!$this->suezGharbia) {
                $this->command->error('Suez/Gharbia governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Suez/Gharbia...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->suezGharbia->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/SuezGharbiaData/suez-gharbia.json');
