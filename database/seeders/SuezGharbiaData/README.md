# Suez/Gharbia Data Seeders

This folder contains seeders for importing medical facilities data for Suez/Gharbia (Tanta & Mahalla) governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Suez/Gharbia governorate
...
- `SuezGharbiaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `suez-gharbia.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\SuezGharbiaData\\SuezGharbiaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\SuezGharbiaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\SuezGharbiaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\SuezGharbiaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\SuezGharbiaData\\FacilityBranchSeeder
```
...
- **Combined Governorate**: Handles combined governorate data (Suez / Gharbia)
...
- This seeder handles combined data from both Suez and Gharbia (Tanta & Mahalla) governorates
