...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Kafr El Sheikh governorate
            $this->kafrElSheikh = Governorate::where('slug', 'kafr-el-sheikh')->first();
            
            if (!$this->kafrElSheikh) {
                $this->command->error('Kafr El Sheikh governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Kafr El Sheikh...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->kafrElSheikh->id,
                        ]
                    );
