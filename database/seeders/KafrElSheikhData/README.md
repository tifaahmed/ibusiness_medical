# Kafr El Sheikh Data Seeders

This folder contains seeders for importing medical facilities data for Kafr El Sheikh governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Kafr El Sheikh governorate
...
- `KafrElSheikhDataSeeder.php` - Main seeder that runs all seeders in correct order
- `kafr-el-sheikh.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\KafrElSheikhData\\KafrElSheikhDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\KafrElSheikhData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\KafrElSheikhData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\KafrElSheikhData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\KafrElSheikhData\\FacilityBranchSeeder
```
...
- **Empty Phones Arrays**: Handles facilities with empty `phones` arrays gracefully
