...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Minya governorate
            $this->minya = Governorate::where('slug', 'minya')->first();
            
            if (!$this->minya) {
                $this->command->error('Minya governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Minya...");
