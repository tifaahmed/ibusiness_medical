...
This folder contains seeders for importing medical facilities data for Minya governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Minya governorate
...
- `MinyaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `minya.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\MinyaData\\MinyaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\MinyaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\MinyaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\MinyaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\MinyaData\\FacilityBranchSeeder
```
