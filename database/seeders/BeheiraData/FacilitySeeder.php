...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Beheira governorate
            $this->beheira = Governorate::where('slug', 'beheira')->first();
            
            if (!$this->beheira) {
                $this->command->error('Beheira governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Beheira...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->beheira->id,
                        ]
                    );
