...
class FacilityBranchSeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            $this->command->info("Starting branch import for Beheira...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    if (!empty($branches) && is_array($branches)) {
                        foreach ($branches as $branchIndex => $branchData) {
                            ...
                            // Check for 'location' field (Beheira format - can be object with ar/en)
                            ...
                            } elseif (!empty($branchData['address'])) {
                    ...
                    if ($currentBranchesCount === 0) {
                        ...
                        // Get address and phone from facility
    ...
    {
        $jsonFilePath = base_path('database/seeders/BeheiraData/beheira.json');
