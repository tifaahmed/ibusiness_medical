...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Qalyubia governorate
            $this->qalyubia = Governorate::where('slug', 'qalyubia')->first();
            
            if (!$this->qalyubia) {
                $this->command->error('Qalyubia governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Qalyubia...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->qalyubia->id,
                        ]
                    );
