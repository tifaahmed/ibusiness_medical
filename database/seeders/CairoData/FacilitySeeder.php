...
class FacilitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            if (!$this->cairo) {
                $this->command->error('Cairo governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Cairo...");
    ...
    {
        $jsonFilePath = base_path('database/seeders/CairoData/cairo.json');
