# Red Sea Data Seeders

This folder contains seeders for importing medical facilities data for Red Sea governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Red Sea governorate
...
- `RedSeaDataSeeder.php` - Main seeder that runs all seeders in correct order
- `red-sea.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\RedSeaData\\RedSeaDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\RedSeaData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\RedSeaData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\RedSeaData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\RedSeaData\\FacilityBranchSeeder
```
