...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Red Sea governorate
            $this->redSea = Governorate::where('slug', 'red-sea')->first();
            
            if (!$this->redSea) {
                $this->command->error('Red Sea governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Red Sea...");
