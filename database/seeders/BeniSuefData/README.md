# Beni Suef Data Seeders

This folder contains seeders for importing medical facilities data for Beni Suef governorate from JSON format.

## Structure

- `GovernorateSeeder.php` - Creates Beni Suef governorate
...
- `BeniSuefDataSeeder.php` - Main seeder that runs all seeders in correct order
- `beni-suef.json` - JSON data file containing all facility information in nested associated array format
...
```bash
php artisan db:seed --class=Database\\Seeders\\BeniSuefData\\BeniSuefDataSeeder
```
...
```bash
# Create governorate
php artisan db:seed --class=Database\\Seeders\\BeniSuefData\\GovernorateSeeder

# Create facility types
php artisan db:seed --class=Database\\Seeders\\BeniSuefData\\FacilityTypeSeeder

# Create facilities
php artisan db:seed --class=Database\\Seeders\\BeniSuefData\\FacilitySeeder

# Create branches
php artisan db:seed --class=Database\\Seeders\\BeniSuefData\\FacilityBranchSeeder
```
