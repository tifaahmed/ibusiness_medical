...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Beni Suef governorate
            $this->beniSuef = Governorate::where('slug', 'beni-suef')->first();
            
            if (!$this->beniSuef) {
                $this->command->error('Beni Suef governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Beni Suef...");
                ...
                foreach ($category['facilities'] as $facilityData) {
                    ...
                    $facility = Facility::updateOrCreate(
                        ...
                        [
                            ...
                            'governorate_id' => $this->beniSuef->id,
                        ]
                    );
    ...
    {
        $jsonFilePath = base_path('database/seeders/BeniSuefData/beni-suef.json');
