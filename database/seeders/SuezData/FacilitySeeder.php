...
class FacilitySeeder extends Seeder
{
    ...
    {
        try {
            // Get Suez governorate
            $this->suez = Governorate::where('slug', 'suez')->first();
            
            if (!$this->suez) {
                $this->command->error('Suez governorate not found. Please run GovernorateSeeder first.');
                return;
            }
            ...
            $this->command->info("Starting facility import for Suez...");
