...
namespace App\Http\Controllers\Admin\MemberPayment\Edit;

use App\Http\Controllers\Controller as BaseController;
use App\Http\Resources\Admin\MemberPayment\Edit\AdminMemberPaymentEditResource;
use App\Models\MemberPayment;
use App\Models\Membership;
use Inertia\Inertia;
use Inertia\Response;

class AdminMemberPaymentEditController extends BaseController
{
    ...
    public function __invoke(MemberPayment $memberPayment): Response
    {
        ...
        return Inertia::render('Admin/MemberPayment/Edit', [
            'payment'     => (new AdminMemberPaymentEditResource($memberPayment))->resolve(),
