...
namespace App\Http\Controllers\Admin\PartnerOffer\Trash;
...
class AdminPartnerOfferTrashController extends BaseController
{
    use CreatorScoped;
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $offers = PartnerOffer::onlyTrashed()
        ...
        return Inertia::render('Admin/PartnerOffer/Trash', [
