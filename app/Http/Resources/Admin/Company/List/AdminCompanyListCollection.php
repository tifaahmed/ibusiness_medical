...
namespace App\Http\Resources\Admin\Company\List;

use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\ResourceCollection;
use Illuminate\Pagination\LengthAwarePaginator;

class AdminCompanyListCollection extends ResourceCollection
{
    public $collects = AdminCompanyListResource::class;
    ...
    {
        $data = [
            'data' => $this->collection->map(fn($r) => $r->resolve($request))->toArray(),
        ];
