...
namespace App\Http\Resources\Admin\Partner\List;

use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\ResourceCollection;
use Illuminate\Pagination\LengthAwarePaginator;

class AdminPartnerListCollection extends ResourceCollection
{
    public $collects = AdminPartnerListResource::class;
