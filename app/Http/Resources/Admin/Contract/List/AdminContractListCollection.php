...
namespace App\Http\Resources\Admin\Contract\List;

use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\ResourceCollection;
use Illuminate\Pagination\LengthAwarePaginator;

class AdminContractListCollection extends ResourceCollection
{
    /**
     ...
     * @var string
     */
    public $collects = AdminContractListResource::class;
