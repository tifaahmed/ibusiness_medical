...
class CompressPartnerOfferMobileImages extends Command
{
    protected $signature = 'partner-offer:compress-mobile-images
                           {--header-width=800 : Max width in pixels for mobile_header_image}
                           {--small-width=400 : Max width in pixels for mobile_small_image}
                           {--jpeg-quality=70 : JPEG quality (1-100)}
                           {--png-quality=60-80 : PNG quant quality range}';

    protected $description = 'Re-copy partner offer images to mobile, then compress/resize them';
    ...
    public function handle(): void
    {
        ...
        $widths = [
            'mobile_header_image' => (int) $this->option('header-width'),
            'mobile_small_image' => (int) $this->option('small-width'),
        ];
